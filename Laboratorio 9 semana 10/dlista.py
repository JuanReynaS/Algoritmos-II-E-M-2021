# Descripción: En este módulo se implementa una lista doble enlazada que será encadenada   
#              a cada slot de la tabla de Hash, esto permitirá resolver colisiones de los
#              datos en la tabla de Hash.
#
#
#
