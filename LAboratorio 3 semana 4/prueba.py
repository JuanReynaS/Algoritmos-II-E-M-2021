...
def sort_three1(A):
    if len(A) == 1:
        ...
        elif A[2] <= A[0] <= A[1]:  # 312
            A[0], A[2] = A[2], A[0]
            A[1], A[2] = A[2], A[1]

        elif A[2] <= A[1] <= A[0]:  # 321
            A[0], A[2] = A[2], A[0]

        elif A[1] <= A[2] <= A[0]:  # 231
            A[0], A[2] = A[2], A[0]
            A[0], A[1] = A[1], A[0]

        elif A[1] <= A[0] <= A[2]:  # 213
            A[1], A[0] = A[0], A[1]
...
lista = [rd.randint(0, 5000) for x in range(0, 3)]
lista_apoyo = lista[:]
print(lista)
inicio = time.time()
lista1 = sort_three(lista)
fin = time.time()
tiempo1 = fin - inicio
verify_list(lista1)
print("lista1", lista1, tiempo1)

print("\nooo", lista_apoyo)

inicio = time.time()
lista2 = sort_three1(lista_apoyo)
fin = time.time()
tiempo2 = fin - inicio
verify_list(lista2)
print("lista2", lista2, tiempo2)
